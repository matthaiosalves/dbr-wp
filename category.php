...
<div class="row" style="margin-top:90px;">
  ...
  <div class="col l8 s12" style="padding:0;">
    ...
    ?>
    <form action="<?php echo esc_url(get_category_link($cat->term_id)); ?>" method="GET" style="margin-bottom:20px;">
      <div class="search-bar">
        <input class="search-input browser-default" type="text" id="keyword" name="keyword" placeholder="Pesquisar notícia em <?php echo esc_attr($category_name); ?>..." value="<?php echo esc_attr($keyword); ?>">
